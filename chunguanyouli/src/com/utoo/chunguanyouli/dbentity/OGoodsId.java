...
/**
 * OGoodsId entity. @author MyEclipse Persistence Tools
 */

public class OGoodsId implements java.io.Serializable {
	...
	/** full constructor */
	public OGoodsId(Integer id, String goodsname, Integer goodsid,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OGoodsId))
			return false;
		OGoodsId castOther = (OGoodsId) other;
