...
/**
 * CgAddressId entity. @author MyEclipse Persistence Tools
 */

public class CgAddressId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1410067474831578613L;
	private Integer id;
	...
	/** full constructor */
	public CgAddressId(Integer id, Integer userid, String area, String address,
			String zip, String receiver, String phone, String mobile,
			Integer isusual, Timestamp dateset) {
		this.id = id;
		this.userid = userid;
		this.area = area;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CgAddressId))
			return false;
		CgAddressId castOther = (CgAddressId) other;
